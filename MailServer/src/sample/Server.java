...
public class Server {
    ...
    public void sendMail(String login, String switch_case) throws IOException {

        String message = "";
        message = DB_work.receiveMail(login, switch_case);
    ...
    public void send_to_deletedMail(String receiver, String text, String sender, String title, String name, String family_name)  {

        DB_work.deleteMail(receiver, text, sender, title);

        DB_work.sendMail(receiver, text, sender, title, name, family_name, "delated");
    }


    public void deleteMail(String receiver, String text, String sender, String title)  {
